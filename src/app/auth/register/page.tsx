    ...
    <div className="min-h-screen bg-brand-black flex items-center justify-center p-6">
      ...
      >
        <div className="text-center mb-10">
          ...
          <h1 className="text-3xl font-serif font-bold text-white mb-2">New Client Intake</h1>
          <p className="text-slate-500 uppercase tracking-widest text-xs font-bold">Register with Bansal & Co.</p>
        </div>
        ...
        <div className="mt-8 text-center">
          <p className="text-slate-500 text-sm">
            Already registered? <Link href="/auth/login" className="text-white hover:text-brand-gold transition-colors font-bold">Login Here</Link>
          </p>
        </div>
      </motion.div>
    </div>
